...
def upgrade_db():
    ...
    try:
        ...
        cur.execute("ALTER TABLE inquiry_suppliers ADD COLUMN IF NOT EXISTS address VARCHAR;")
        cur.execute("ALTER TABLE inquiry_suppliers ADD COLUMN IF NOT EXISTS legal_rep VARCHAR;")
        cur.execute("ALTER TABLE inquiry_suppliers ADD COLUMN IF NOT EXISTS agent VARCHAR;")
        cur.execute("ALTER TABLE inquiry_suppliers ADD COLUMN IF NOT EXISTS phone VARCHAR;")
